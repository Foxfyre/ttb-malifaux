import { ttbActorSheet } from "./scripts/actors/actor-sheet.js";
import { ttbActor } from "./scripts/actors/actor.js";
import { ttbItemSheet } from "./scripts/items/item-sheet.js";
import { ttbItem } from "./scripts/items/item.js";
import { ttbScene } from "./scripts/scenes/scene.js";
...
Hooks.once("init", async function () {
  ...
  CONFIG.Scene.documentClass = ttbScene;
  ...
  Actors.registerSheet("ttb", ttbActorSheet, {
    types: ["character", "npc"],
    makeDefault: true
  });

  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("ttb", ttbItemSheet, {
    makeDefault: true
  });
